...
This legacy example demonstrates how Red5 Pro playback can be integrated with JW Player through a custom provider. For current production deployments, please refer to the latest [Red5 HTML SDK documentation](https://www.red5.net/docs/red5-pro/development/sdks/red5-webrtc-sdk/).
